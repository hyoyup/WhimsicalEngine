...
void WEEngine::MainLoop()
{

#if BENCHMARK_MODE
    std::chrono::system_clock::time_point start = std::chrono::system_clock::now();
#endif
	m_pFrameRateManager->FrameStart();
    //m_pTimer->Tick();
...
void WEEngine::TurnOnFullscreen()
{
...
void WEEngine::TurnOffFullscreen()
{
...
void WEEngine::ToggleScreenSize()
{
...
void WEEngine::Pause(bool a_bPause)
{
...
void WEEngine::ProcessWindowsMessages(MSG& a_message)
{
...
void WEEngine::HandleSceneChange()
{

}

void WEEngine::HandlePauseChange()
{
    //if (m_bDirtyPause)
    //{
    //    m_bDirtyPause = false;
...
LRESULT CALLBACK WEEngine::HWndProc(HWND a_hWindow, UINT a_uMessage, WPARAM a_uWideParam, LPARAM a_uLongParam)
{
...
LONG WINAPI WEEngine::WndUnhandledExceptionProc(struct _EXCEPTION_POINTERS * a_pExceptionInfo)
{
